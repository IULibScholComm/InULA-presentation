...
![open access logo](images\oa_logo-trans.svg){.absolute top=200 left=0 width="350" height="300"}
...
![Quarto homepage](images\quarto.jpg){.absolute top=200 left=0 width="350" height="300"}
